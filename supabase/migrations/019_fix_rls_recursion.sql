-- Fix RLS recursion infinie : les politiques admin interrogeaient profiles depuis des
-- politiques sur profiles, créant une boucle profiles → auctions → profiles (ou profiles → profiles).
-- Solution : fonction security definer qui contourne RLS pour la vérification admin.
